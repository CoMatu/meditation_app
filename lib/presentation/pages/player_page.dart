...
class PlayerPage extends StatefulWidget {
  ...
  PlayerPage(this.player, this.duration, {Key key}) : super(key: key);
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            GestureDetector(
                              onTap: () async {
                                sl<MainAudioService>().stopAudio(widget.player);
                          ...
                          ? Consumer<BottomPanelProvider>(
                              builder: (context, state, child) {
                                return Column(
                                  children: <Widget>[
                                    state.panelState
                                        ? PausedButtonPanel(widget.player)
                                        : ResumeButtonPanel(widget.player),
                                    Container(
                                      height: 58.0,
                                    ),
                                  ],
